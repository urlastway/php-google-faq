...
<body>
    <div class="page" style="width: 100%; height: auto; display: flex; justify-content: center;">
        <div class="container" style="max-width: 1280px; display: flex; flex-direction: column;">
            <?php foreach($fraqs as $fraq) { ?> 
                <h2 style="font-family: 'Open Sans', sans-serif; font-weight: 700; font-size: 28px; color: grey;"><?php echo $fraq['domanda']?></h2>
                <p style="font-family: 'Open Sans', sans-serif;"><?php echo $fraq['risposta']?></p>
            <?php } ?>
        </div>
    </div>
